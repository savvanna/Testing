...
namespace AircompanyTests.Tests
{
    ...
    public class AirportTest
    {
        ...
        public void TestHasMilitaryTransportPlane()
        {
            ...
            Assert.That(transportMilitaryPlanes.Any(plane => plane.Type == MilitaryType.Transport));
        }

        [Test]
        public void TestPlaneWithMaxPassengersCapacity()
        {
            Airport airport = new Airport(planes);
            PassengerPlane expectedPlaneWithMaxPassengersCapacity = airport.PassengerPlaneWithMaxPassengersCapacity;
            Assert.Equals(planeWithMaxPassengerCapacity, expectedPlaneWithMaxPassengersCapacity);
        }
        ...
        public void TestPlanesSortedByMaxLoadCapacity()
        {
            ...
            bool nextPlaneMaxLoadCapacityIsHigherThanCurrent = planesSortedByMaxLoadCapacity
                .Zip(planesSortedByMaxLoadCapacity.Skip(1), (current, next) => current.MaxLoadCapacity <= next.MaxLoadCapacity)
                .All(x => x);
